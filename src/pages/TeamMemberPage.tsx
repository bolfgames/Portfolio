          ...
          <div className="max-w-6xl mx-auto">
            ...
            {furkanData && member?.name.toLowerCase().includes('furkan') ? (
              ...
              <div className="space-y-12">
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-bolf-gray">
                      <div className="flex items-center gap-2">
                        ...
                        <a href={`mailto:${emirData.contact.email}`} className="hover:text-bolf-neon-blue transition-colors">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a href={`tel:${emirData.contact.phone}`} className="hover:text-bolf-neon-blue transition-colors">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a href={`https://${emirData.contact.linkedin}`} target="_blank" rel="noopener noreferrer" className="hover:text-bolf-neon-blue transition-colors">
                          LinkedIn
                        </a>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <a href={`https://${emirData.contact.artstation}`} target="_blank" rel="noopener noreferrer" className="hover:text-bolf-neon-blue transition-colors">
                          ArtStation
                        </a>
                      </div>
                    </div>
                ...
                {/* Education Section */}
                <EducationSection education={emirData.education} />

                {/* Experience Section */}
                <ExperienceSection experiences={emirData.experience} />

                {/* Skills Section */}
                <SkillsSection skills={emirData.skills} />
